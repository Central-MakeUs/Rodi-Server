...
/**
 * 내 연습 목록 아이템. 화면에 쓰는 값(장소명·연습유형·연습 횟수·방문일·후기 작성 여부)과 동작에 필요한 식별자만 담는다. 미방문 사유는 수집 목적이라 응답에 내리지
 * 않는다.
 */
public record PracticeItem(
        @Schema(description = "연습 항목 id(상태 변경·사유 제출·삭제에 사용)") Long practiceId,

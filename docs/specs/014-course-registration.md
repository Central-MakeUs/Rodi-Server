...
| 미승인 | 그 외 | 404 `COURSE_404_1` |
| **삭제됨** | 누구나(등록자 포함) | **404 `COURSE_404_2` "삭제된 코스입니다."** |

- 삭제된 코스에 **전용 에러 코드**를 주는 이유: 북마크·연습 목록에 항목이 남아 있어 사용자가 탭할 수 있다. "코스를 찾을 수 없습니다"와 구분해 **"삭제된 코스입니다"** 를 띄우기 위함이다([015](015-my-course-management.md)).
...
> 삭제 권한(403)은 [015](015-my-course-management.md), 승인 관련은 [016](016-course-approval.md)에서 같은 enum에 추가한다.
...
- [ ] 미승인 코스 상세는 제3자에게 404, **등록자 본인에게는 200**이다.
